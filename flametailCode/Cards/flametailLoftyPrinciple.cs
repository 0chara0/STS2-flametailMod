...
public sealed class flametailLoftyPrinciple : ModCardTemplate
{
    ...
    private static readonly CardAssetProfile _assetProfile = new(
        PortraitPath: $"{Entry.ResPath}/images/cards/{"flametailLoftyPrinciple"}.png");
    ...
    {
        await PowerCmd.Apply<flametailLoftyPrinciplePower>(
            choiceContext,
            Owner.Creature,
