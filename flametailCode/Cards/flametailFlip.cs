...
public sealed class flametailFlip : ModCardTemplate, IGainFootworkCard
{
    ...
    private static readonly CardAssetProfile _assetProfile = new(
        PortraitPath: $"{Entry.ResPath}/images/cards/{"flametailFlip"}.png");
    ...
    public flametailFlip() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
    }
