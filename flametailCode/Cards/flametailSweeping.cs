...
public sealed class flametailSweeping : ModCardTemplate
{
    ...
    public flametailSweeping() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
    }
