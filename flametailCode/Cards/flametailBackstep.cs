...
public sealed class flametailBackstep : ModCardTemplate, ICounterCard, IGainFootworkCard
{
    ...
    public flametailBackstep() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
    }
