...
public sealed class flametailMeteorTail : ModCardTemplate, ICounterCard, IGainFootworkCard
{
    ...
    private static readonly CardAssetProfile _assetProfile = new(
        PortraitPath: $"{Entry.ResPath}/images/cards/{"flametailMeteorTail"}.png");
    ...
    public flametailMeteorTail() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
    }
